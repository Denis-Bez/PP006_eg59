...
spam_filter = {
    'name': ['Zimer', 'RobertLot', 'https', 'http', 'RobertRemia', 'Clezerip', 'AlexBess', 'Alisa', 'Lot', 'David', 'Remia', 'William', 'Miprog',
            ...
            'BuildGroup', 'Tim', 'bonus', 'Monte', 'Marcusnop', 'Demetria', 'Prodvigenie', 'Garland', 'Jens'
            ],
    'phone': [],
    ...
    'Аренда автобуса', 'Бесплатно продвинем', 'продвижение сайтов', 'роста продаж', 'xyz', 'создание сайтов', 'сайтов'
    ]
}