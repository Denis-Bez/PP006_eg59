...
spam_filter = {
    ...
    'text': ['.ру', 'nуmрhоmaniа', 'нимфoманией', 'биceкcyал', 'любoвью', 'наркомании', 
             ...
             'url', 'ttp:', 'порно', 'кролика', 'Букмекеры', 'buzz', 'SEO продвижение', 'базы директоров',
             'вирусную', 'Безлимитный', 'Подберем', 'базы Директоров', 'Domain', 'Лидов', 'продвижением', 
             'лидогенерация', 'SEO', 'прогон сайта', 'база Дизайнеров', 'повышу конверсию', 'копирайтинга', 
             'Хрумер', 'Заказать прогон', 'Кликфрод', 'Яндекс Директа', 'millions', 'привлекаем', 'опубликовать книгу', 
             'www', 'секс', 'Gillian', 'Rininger', 'Срочно набираем сотрудников', 'Помогу вам', 'купить пару-тройку', 
             'interesting', 'casino', 'farmacia', 'Запарили спамеры', 'Hey', 'Юридический адрес в Новосибирске', 
             'Купить виллу', 'bonus', 'Заинтересовал ваш продукт, можете перезвонить', 'хороший велосипед', 'Благотворительный', 
             'по вашим товарам и доставке', 'Аренда автобуса', 'Бесплатно', 'продвижение сайтов', 'роста продаж', 'xyz', 
             'создание сайтов', 'сайтов', 'создание сайта', 'перезвоните в любое удобное время', 'Хотел бы сделать заказ в вашей компании', 
             ...
             'And Bye', 'форекс', 'Телетрейд', 'writes', 'Высокая технология', 'NFTs', 'AI', 'Happening', 'Product', 'generic']
}