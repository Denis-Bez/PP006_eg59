...
spam_filter = {
    ...
    'text': ['.ру', 'nуmрhоmaniа', 'нимфoманией', 'биceкcyальнa', 'любoвью', 'наркомании', 
    ...
    'вирусную', 'Безлимитный интернет', 'Подберем новых', 'базы Директоров', 'Domain', 'Лидов', 'продвижением сайтов',
    'лидогенерация', 'SEO', 'прогон сайта', 'база Дизайнеров', 'повышу конверсию', 'копирайтинга', 'Хрумер', 'Заказать прогон', 'Кликфрод',
    'Яндекс Директа', 'millions', 'привлекаем клиентов', 'опубликовать книгу', 'www', 'секс', 'Gillian', 'Rininger', 'Срочно набираем сотрудников',
    'Помогу вам увеличить', 'купить пару-тройку', 'very interesting', 'casino', 'farmacia', 'Запарили спамеры', 'Hey', 'Юридический адрес в Новосибирске',
    'Купить виллу', 'bonus', 'Заинтересовал ваш продукт, можете перезвонить', 'хороший велосипед', 'Благотворительный', 'по вашим товарам и доставке',
