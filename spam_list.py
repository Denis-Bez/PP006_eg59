...
spam_filter = {
    'name': ['Zimer', 'RobertLot', 'https', 'RobertRemia', 'Clezerip', 'AlexBess', 'Alisa', 'Lot', 'David', 'Remia', 'William'],
    'phone': [],
    'email': [],
    ...
    '\[url=', 'https://', 'http://', 'порно', '/кролика', 'Букмекеры', '.buzz', 'SEO продвижение', 'базы директоров', 
    'вирусную', 'Безлимитный интернет', 'Подберем новых', 'базы Директоров', 'Domain Rating', 'база Лидов'
    ]
}